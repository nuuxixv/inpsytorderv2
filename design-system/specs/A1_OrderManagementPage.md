...
- [ ] 시작일 입력: 라벨 “시작일” (기본값 = today − 3, 2026-07-13 30→3일로 축소) — `ui/DateField`(캘린더 팝오버, native date 폐기, 2026-06-10 통일. 2026-06-15: 직접 타이핑 입력+오늘 강조+6행 고정 캘린더)
...
- [ ] 초기화 버튼 → 모든 필터·검색어·날짜 기본값(최근 3일) 복원
