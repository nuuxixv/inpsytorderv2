            ...
            {products.map((product) => (
              <TableRow key={product.id}>
                ...
                <TableCell align="center">
                  <Button size="small" onClick={() => handleOpen(product)}>수정</Button>
                </TableCell>
              </TableRow>
            ))}
          </TableBody>
          ...
          <FormControlLabel
            control={
              <Checkbox
                ...
                onChange={(e) => handleChange({ target: { name: 'is_discountable', value: e.target.checked } })}
