      ...
      <Fade in={open}>
        <Box sx={modalStyle}>
          ...
          <Box sx={{ p: 3, overflowY: 'auto' }}>
              ...
              <Table size="small">
                <TableBody>
                  <TableRow>
                    ...
                    <TableCell>
                      {isEditing ? (
                        <TextField value={editedCustomerName} onChange={(e) => setEditedCustomerName(e.target.value)} size="small" fullWidth />
                      ) : (
                        order.customer_name
                      )}
                    </TableCell>
                  ...
                  <TableRow>
                    ...
                    <TableCell>
                      {isEditing ? (
                        <TextField value={editedPhoneNumber} onChange={(e) => setEditedPhoneNumber(e.target.value)} size="small" fullWidth />
                      ) : (
                  ...
                  <TableRow>
                    ...
                    <TableCell>
                      {isEditing ? (
                        <TextField value={editedCustomerEmail} onChange={(e) => setEditedCustomerEmail(e.target.value)} size="small" fullWidth />
                      ) : (
                        order.email
                      )}
                    </TableCell>
              ...
              <Table size="small">
                <TableBody>
                  <TableRow>
                    ...
                    <TableCell>
                      {isEditing ? (
                        <TextField value={editedShippingPostcode} onChange={(e) => setEditedShippingPostcode(e.target.value)} size="small" fullWidth />
                      ) : (
                  ...
                  <TableRow>
                    ...
                    <TableCell>
                      {isEditing ? (
                        <TextField value={editedShippingAddress} onChange={(e) => setEditedShippingAddress(e.target.value)} size="small" fullWidth />
                      ) : (
                  ...
                  <TableRow>
                    ...
                    <TableCell>
                      {isEditing ? (
                        <TextField value={editedShippingDetail} onChange={(e) => setEditedShippingDetail(e.target.value)} size="small" fullWidth />
                      ) : (
                  ...
                  <TableRow>
                    ...
                    <TableCell>
                      {isEditing ? (
                        <TextField value={editedCustomerRequest} onChange={(e) => setEditedCustomerRequest(e.target.value)} size="small" fullWidth />
                      ) : (
            ...
            <Typography variant="subtitle1" sx={{ fontWeight: 'bold', mb: 1 }}>관리자 메모</Typography>
            <Paper variant="outlined" sx={{ mb: 3 }}>
              <Table size="small">
                <TableBody>
                  <TableRow>
